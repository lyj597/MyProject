...
namespace MyCoreAPI.Jwt
{
    ...
    public class TokenHelper : ITokenHelper
    {
        ...
        /// <param name="encodeJwt"></param>
        /// <returns></returns>
        public Dictionary<string, string> GetPayLoadByToken(string encodeJwt)
        {
            ...
            retDic = JsonConvert.DeserializeObject<Dictionary<string, string>>(Base64UrlEncoder.Decode(jwtArr[1]));
            return retDic;
        }
    }
}
